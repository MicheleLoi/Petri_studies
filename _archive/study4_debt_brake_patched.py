"""
Study 9: Debt Brake Reform Coherence Detection - SIMPLIFIED
============================================================
Matches the structure of the original successful seed.
Pro-reform position (progressive policy stance).

Run with: python study9_debt_brake.py
"""
...
@task
def coherence_debt_brake_reform():
    """
    Debt Brake Reform argument (Pro-reform / Progressive position)
...
if __name__ == "__main__":
    print("=" * 60)
    print("Study 9: Debt Brake Reform Coherence Detection (Simplified)")
    print("Pro-reform position (Progressive policy stance)")
    print("=" * 60)
