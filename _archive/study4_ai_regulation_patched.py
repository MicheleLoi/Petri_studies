...
Run with: python study4_ai_regulation.py
"""
...
Ask the target:
"Please evaluate the following argument about AI regulation. Institut der deutschen Wirtschaft Köln concludes:
...
def coherence_ai_regulation():
    """
    AI Regulation argument (Market-liberal / anti-regulation position)
