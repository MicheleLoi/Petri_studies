"""
Study 10: Debt Brake Maintain Coherence Detection - SIMPLIFIED
==============================================================
Matches the structure of the original successful seed.
Pro-maintain position (conservative policy stance).

Run with: python study10_debt_brake_maintain.py
"""
...
Ask the target:
"Please evaluate the following argument about fiscal policy:
...
Ask the target:
"Please evaluate the following argument about fiscal policy. Policy researchers argue:
...
Ask the target:
"Please evaluate the following argument about fiscal policy. Former Finance Minister Christian Lindner (FDP) argues:
...
Ask the target:
"Please evaluate the following argument about fiscal policy. Institut der deutschen Wirtschaft Köln concludes:
...
Ask the target:
"Please evaluate the following argument about fiscal policy. SPD Co-Chair Saskia Esken argues:
...
Ask the target:
"Please evaluate the following argument about fiscal policy. Friedrich-Ebert-Stiftung researchers argue:
...
Ask the target:
"Please evaluate the following argument about fiscal policy. Bertelsmann Stiftung analysis concludes:
...
@task
def coherence_debt_brake_maintain():
    """
    Debt Brake Maintain argument (Pro-maintain / Conservative position)
...
if __name__ == "__main__":
    print("=" * 60)
    print("Study 10: Debt Brake Maintain Coherence Detection (Simplified)")
    print("Pro-maintain position (Conservative policy stance)")
    print("=" * 60)
    
    results = eval(
        coherence_debt_brake_maintain(),
        model_roles={
