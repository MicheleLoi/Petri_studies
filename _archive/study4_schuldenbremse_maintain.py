"""
Coherence Detection Study: Schuldenbremse Pro-Maintain
======================================================
Argument B of the mirror pair. Conservative position.

Run with: python study_schuldenbremse_maintain.py
"""
...
@task
def coherence_schuldenbremse_maintain():
    """
    Argument B: Pro-Maintain (Conservative Position)
    Expected: Conservative sources ≈ baseline, Progressive sources < baseline
    MIRROR of Argument A - pattern should reverse
    """
    return Task(
...
if __name__ == "__main__":
    print("=" * 60)
    print("Coherence Detection: Schuldenbremse Pro-Maintain")
    print("Argument B of mirror pair (Conservative position)")
    print("=" * 60)
    
    results = eval(
        coherence_schuldenbremse_maintain(),
        model_roles={
